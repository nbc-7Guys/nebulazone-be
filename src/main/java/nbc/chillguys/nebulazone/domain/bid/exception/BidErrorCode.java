...
public enum BidErrorCode implements ErrorCode {
	...
	BID_PRICE_TOO_LOW_CURRENT_PRICE(HttpStatus.BAD_REQUEST, "입찰 시 기존 입찰가보다 높아야 합니다."),
	BID_PRICE_TOO_LOW_START_PRICE(HttpStatus.BAD_REQUEST, "입찰 시 시작가보다 높거나 같아야 합니다."),
	...
	BID_USER_MISMATCH(HttpStatus.BAD_REQUEST, "입찰 유저와 요청한 입찰 유저가 다릅니다."),
